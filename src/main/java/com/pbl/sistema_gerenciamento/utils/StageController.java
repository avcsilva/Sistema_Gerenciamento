...
import com.pbl.sistema_gerenciamento.controller.GereMontagemController;
...
public class StageController {
    ...
    public static void  openScreenNewWindow(String URl) throws IOException {
        ...
        //stage.getIcons().add(new Image(HelloApplication.class.getResourceAsStream("icons/pngwing.com.png")));
        stage.showAndWait();
    }
